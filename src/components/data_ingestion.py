...
class DataIngestConfig:
    ...
    train_test_path = os.path.join("artifact","test.csv")
...
class DataIngestion:
    ...
    def initiate_data_ingestion(self):
        logging.info("Data ingestion initiated or Entered")
        try:
            ...
            test_set.to_csv(self.ingestion_config.train_test_path,index=False,header=True)
